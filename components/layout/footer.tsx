        ...
        <div className="py-10 md:py-16">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
            ...
            <div className="col-span-2 lg:col-span-2 flex flex-col gap-4">
              <Link href="/" aria-label="Velvet Spark — Home" className="inline-block focus-visible:outline-none">
                <span className="font-display text-2xl font-bold text-ivory leading-none">
                  Velvet <span className="text-gradient-gold">Spark</span>
                </span>
              </Link>
              ...
              <p className="text-sm text-charcoal-300 leading-relaxed max-w-xs">
                Premium artificial jewelry crafted with passion. Elegance you can wear every day, without compromise.
              </p>
                ...
                <ul className="flex flex-col gap-2" role="list">
                  {group.links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-xs sm:text-sm text-charcoal-300 hover:text-ivory transition-colors duration-200"
                      >
                        {link.label}
                      </Link>
                    </li>
          ...
          {/* ── Bottom: Copyright + Legal ── */}
          <div className="mt-10 pt-6 border-t border-charcoal-400 flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-3 text-center sm:text-left">
              ...
              <p className="text-xs text-charcoal-400">
                Developed by{" "}
                <span className="text-gold font-medium">Pardeep Sharma</span>
              </p>
            </div>
