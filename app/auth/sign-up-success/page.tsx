...
// 1. This component is wrapped in Suspense to allow for a loading state while we wait for the redirect timer.
...
// 2. this will be the default export, which wraps the SuccessContent in Suspense
