...
//   // ✅ Redux se real orders lo
//   const reduxOrders = useAppSelector(selectOrders);

//   // ✅ Redux orders ko Order format mein convert karo
//   const realOrders = reduxOrders.map((order) => ({
//     id: order.id,
//     date: order.date,
//     status: order.status,
//     product: {
...
//   // ✅ Real orders pehle, phir mock orders
                    ...
                    <div className="bg-card border border-border rounded-lg p-4 md:p-6">
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mt-3">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                          <span className={`text-xs font-medium px-3 py-1 rounded-full ${STATUS_STYLES[order.status]}`}>
                            {order.status}
                          </span>
