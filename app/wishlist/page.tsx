                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-white/95 dark:from-charcoal-700/95 to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity duration-300 rounded-b-xl flex gap-2">
                    <button
                      ...
                      className="flex-1 h-8 rounded-lg bg-gold text-white text-xs font-medium hover:bg-gold-700 transition-colors"
                    >
                      Add to Cart
                    </button>
                    <button
                      ...
                      className="h-8 w-8 flex items-center justify-center rounded-lg border border-destructive/40 text-destructive hover:bg-destructive hover:text-white transition-all"
